...
export default function OnboardingForm() {
    ...
    async function onSubmit(values: FormValues) {
        try {
            ...
            const res = await fetchAPI<TNoParams, TNoParams, Partial<FormValues>>({
                url: "/company",
                method: "POST",
                body: {
                    ...rest,
    ...
    async function handleUpload(file: File) {
        ...
        try {
            ...
            form.setValue("valuation", parseInt(String(data.valuation).replace(/,/g, "")));
    ...
    return (
        <Form {...form}>
            <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-3xl mx-auto py-10">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>This is your company display name.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>A forward-looking declaration of the startup's long-term aspirations.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>A concise statement outlining the startup's purpose.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>The estimated monetary worth of the startup.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>The primary sector or industry the startup operates in.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>A comprehensive document or summary describing the startup's goals.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
