...
import { Table, TableHeader, TableRow as TR, TableHead as TH, TableCell as TD, TableBody } from '@/components/ui/table';
...
export default function TableData({ columns, setColumns, setTableData, tableData }: TableDataProps) {
    ...
    return (
        <div className='pt-6'>
            <h1 className='text-2xl font-bold'>Send Bulk Mails to your customers</h1>
