		...
		<section id="features">
			...
			<div className="pb-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 mx-auto px-8">
				<Card
					...
					desc="Just dump your csv, we'll extract the info!"
					icon={<File size={48} />}
				>
					<CanvasRevealEffect
						animationSpeed={5.1}
				...
				<Card
					...
					desc="Drop your image, place your texts, we'll handle the customization!"
				...
				<Card
					title="Bulk Emailing"
					desc="Email all your users just in one click!"
					icon={<Mail size={48} />}
				>
					<CanvasRevealEffect
						animationSpeed={3}
